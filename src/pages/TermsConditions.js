      ...
      <div className="terms-details">
        <div className="feature">
          ...
          <div className="feature-text">
            ...
            <p>🏷️50% Advance payment is mandatory while booking photoshoot slot.</p>
            <p>🔖100% payment is mandatory before start of photoshoot.</p>
            <p>🏷️Any damage to property or photoshoot set by customer or photographer should be compensated by them.</p>
            <p>🔖We believe in policy that Customer is KING and KING never Bargains.</p>
          </div>
        </div>
